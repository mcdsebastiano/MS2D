const Shape = function () {
  ...
  this.d1 = 0;
  this.d2 = 0;
  this.uniformLocation = gl.getUniformLocation(gl.program, 'u_ModelMatrix');
};
...
=======
  gl.uniformMatrix4fv(this.uniformLocation, false, this.matrix.elements);
>>>>>>> 7a521c8... small changes to setup to promote better performance, stress test @ 50000 Rects under 1 sec, this is actually not that bad for us.
