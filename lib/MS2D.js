(function (MS2D) {
  ...
  MS2D.addEventListener('DOMContentLoaded', () => {
    ...
    MS2D.DIMGRAY      =   { r: 105 / 255,  g: 105 / 255, b: 105 / 255, a: 1.0 };
    MS2D.GRAY         =   { r: 128 / 255,  g: 128 / 255, b: 128 / 255, a: 1.0 };
    MS2D.LIGHTGRAY    =   { r: 223 / 255,  g: 224 / 255, b: 220 / 255, a: 1.0 };
    MS2D.SILVER       =   { r: 192 / 255,  g: 192 / 255, b: 192 / 255, a: 1.0 };
    MS2D.WHITE        =   { r: 1,          g: 1,         b: 1,         a: 1.0 };
    MS2D.LIGHTTAN     =   { r: 198 / 255,  g: 189 / 255, b: 156 / 255, a: 1.0 };
    MS2D.TAN          =   { r: 210 / 255,  g: 180 / 255, b: 140 / 255, a: 1.0 };
    MS2D.GOLD         =   { r: 212 / 255,  g: 175 / 255, b: 55  / 255, a: 1.0 };
    MS2D.VIOLET       =   { r: 105 / 255,  g: 73  / 255, b: 124 / 255, a: 1.0 };
    MS2D.DARKGREEN    =   { r: 34  / 255,  g: 139 / 255, b: 34  / 255, a: 1.0 };
    MS2D.BROWN        =   { r: 165 / 255,  g: 42  / 255, b: 42  / 255, a: 1.0 };
    MS2D.LIGHTBROWN   =   { r: 165 / 255,  g: 132 / 255, b: 99  / 255, a: 1.0 };
    MS2D.BLACK        =   { r: 0        ,  g: 0        , b: 0        , a: 1.0 };
    MS2D.PURPLE       =   { r: 160 / 255,  g: 0        , b: 240 / 255, a: 1.0 };
    MS2D.BLUE         =   { r: 45  / 255,  g: 100 / 255, b: 235 / 255, a: 1.0 };
    MS2D.ORANGE       =   { r: 255 / 255,  g: 165 / 255, b: 0   ,      a: 1.0 };
    MS2D.YELLOW       =   { r: 255 / 255,  g: 255 / 255, b: 0   ,      a: 1.0 };
    MS2D.GREEN        =   { r: 115 / 255,  g: 245 / 255, b: 20  / 255, a: 1.0 };
    MS2D.RED          =   { r: 255 / 255,  g: 0   ,      b: 0   ,      a: 1.0 };
    MS2D.MAROON       =   { r: 106 / 255,  g: 30  / 255, b: 32  / 255, a: 1.0 };
    MS2D.BEIGE        =   { r: 229 / 255,  g: 198 / 255, b: 170 / 255, a: 1.0 };
    MS2D.OFFWHITE     =   { r: 248 / 255,  g: 248 / 255, b: 1,         a: 1.0 };
    MS2D.WHITESMOKE   =   { r: 245 / 255,  g: 245 / 255, b: 245 / 255, a: 1.0 };
    MS2D.CHARCOAL     =   { r: 24  / 255,  g: 24  / 255, b: 24  / 255, a: 1.0 };
    MS2D.CYAN         =   { r: 0   ,       g: 1,         b: 1,         a: 1.0 };
